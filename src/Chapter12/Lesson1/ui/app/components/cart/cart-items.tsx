...
import { cartItemsCatalogItemTotal_basketItem$key } from "./__generated__/cartItemsCatalogItemTotal_basketItem.graphql";
import { cartItemsCatalogItemInfo_basketItem$key } from "./__generated__/cartItemsCatalogItemInfo_basketItem.graphql";
      ...
      fragment cartItems_viewer on Viewer {
        basket {
          items {
            ...
            ...cartCatalogItemQuantity_basketItem_updateable
...
function CartCatalogItemInfo({
  ...
  $ref: cartItemsCatalogItemInfo_basketItem$key;
}) {
...
function CartCatalogItemTotal({
  ...
  $ref: cartItemsCatalogItemTotal_basketItem$key;
}) {
  const data = useFragment(
    graphql`
