...
import cartQuery from "./pages/cart-query";
import homeQuery from "./pages/home-query";
    ...
    children: [
      {
        ...
        index: true,
        element: <Home />,
        loader: () => loadQuery(environment, homeQuery, {}),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        element: <Cart />,
        path: "cart",
        loader: () => loadQuery(environment, cartQuery, {}),
      },
      {
        id: "checkout",
        element: <Checkout />,
