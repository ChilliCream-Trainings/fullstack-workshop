...
public static class BasketOperations
{
        ...
        CancellationToken ct)
    {
        ...
        // todo: how do we want to validate the product?
    ...
    [Authorize]
    public static async
        Task<FieldResult<ShoppingBasket, QuantityCannotBeNegativeError, InvalidBasketItemId>>
        ChangeQuantityAsync(
        string id,
        int quantity,
        UserInfo userInfo,
    ...
    [Mutation]
    [Authorize]
    public static async Task<FieldResult<ShoppingBasket, InvalidBasketItemId>>
