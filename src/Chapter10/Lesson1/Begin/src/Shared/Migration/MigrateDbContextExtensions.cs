...
public static class MigrateDbContextExtensions
{
        ...
        where TContext : DbContext
    {
        ...
        services.AddOpenTelemetry().WithTracing(tracing => tracing.AddSource(ActivitySource.Name));
        ...
        Func<TContext, IServiceProvider, Task> seeder) where TContext : DbContext
    {
        ...
        using var activity =
            ActivitySource.StartActivity($"Migration operation {typeof(TContext).Name}");
